...
export const StaggeredMenu = ({
  ...
  return (
    <div
      className={`sm-scope pointer-events-none z-40 ${isFixed ? "fixed top-0 left-0 w-screen h-screen overflow-hidden" : "relative w-full h-0"} `}
    >
      <div
        className={
          (className ? className + " " : "") +
      ...
      >
        ...
        {open && (
          <button
            type="button"
            className="sm-clickaway absolute top-0 left-0 z-[6] h-screen w-screen border-0 bg-transparent p-0 pointer-events-auto"
...
.sm-scope .sm-prelayers { position: absolute; top: 0; right: 0; height: 100vh; width: clamp(260px, 38vw, 420px); pointer-events: none; z-index: 5; }
